...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.fastgs_mult = 1.0
        self.fastgs_score_cameras = 5
        self.fastgs_loss_thresh = 0.4
        self.fastgs_grad_abs_threshold = 0.0002
        self.fastgs_importance_threshold = 5
        self.fastgs_prune_from_iter = 10_000
        self.fastgs_prune_score_threshold = 0.9
